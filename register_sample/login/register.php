    ...
    <script>
        $(document).ready(function () {
            $("#country").countrySelect({
                defaultCountry: "gh",
                preferredCountries: ["gh", "ng", "ke", "za", "us", "gb"]
            });
            ...
            $("#country").on("change", function () {
                ...
                if (countryData && dialCodes[countryData.iso2]) {
                    $("#phone_number").val(dialCodes[countryData.iso2] + " ");
                    $("#phone_number").focus();
                }
            });
        });
